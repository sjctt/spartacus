...
*/
//import des_ecb from 'assets/js/js-des/mode-ecb.js';
...
//加密
var des_encryp = function (str,callback)
{
    var keyHex = CryptoJS.enc.Utf8.parse("spartacus1");
...
//解密
var encryp=function (ciphertext,callback) {
    ...
    callback(decrypted.toString(CryptoJS.enc.Utf8).toString());
}
