        ...
        <div class="ml-auto">
          ...
          <div class="header-icons d-inline-block align-middle">
            ...
            <!-- <div class="position-relative d-none d-none d-lg-inline-block">
              <a class="btn btn-outline-primary btn-sm mb-2 mr-3" target="_top" :href="#">{{$t('user.buy')}}</a>
            </div> -->
            <!--购买按钮 end-->
          ...
          <div class="user d-inline-block">
            <b-dropdown   class="dropdown-menu-right"  right variant="empty" toggle-class="p-0" menu-class="mt-3" no-caret>
                <template slot="button-content">
                    ...
                    <span><img alt="111" src="assets/img/profile-pic-l.jpg"/></span>
                    <span  class="name mr-1" id="loginUser" style="margin-left:10px"></span><!--当前登录用户-->
                </template>
                <!-- <b-dropdown-divider /> -->
...
export default {
  ...
  watch: {
    ...
    mounted:function()
    {
        var jsonStr = sessionStorage.getItem("loginuser_inf");
        var loginUser_inf = JSON.parse(jsonStr);
        document.getElementById("loginUser").innerHTML=loginUser_inf.account.replace(/\"/g,"");
    },
};
</script>
