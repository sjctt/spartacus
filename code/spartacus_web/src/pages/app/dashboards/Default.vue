    ...
    <b-row>
      ...
      <b-colxx lg="4" md="6" class="mb-4">
        <b-card :title="$t('dashboards.logs')">
           <vue-perfect-scrollbar class="dashboard-logs" :settings="{ suppressScrollX: true, wheelPropagation: false }">
              <log-list :logs="logs" />
          </vue-perfect-scrollbar>
        </b-card>
      </b-colxx>
          ...
          <b-card-body>
            ...
            <b-form class="form-container">
                ...
                <b-form-group class="text-center">
                  <b-button type="submit" variant="primary" class="mt-4 pl-5 pr-5">{{ $t('dashboards.search') }}</b-button>
                </b-form-group>
            </b-form>
          </b-card-body>
        </b-card>
...
import {lineChartData,polarAreaChartData,areaChartData,conversionChartData,smallChartData1,smallChartData2,smallChartData3,smallChartData4} from "data/charts"
