  ...
  <b-row>
    <b-colxx xxs="12">
      ...
      <div class="float-sm-right mb-2">
         <b-dropdown id="ddown5" :text="$t('layouts.actions')" size="lg" variant="outline-primary" class="top-right-button top-right-button-single" no-fade="true">
          ...
          <b-row>
            <b-colxx xxs="12" lg="4" class="mb-4">
              <b-card class="mb-4" no-body>
                  ...
                  <b-card-body>
                    <p class="text-muted text-small mb-2">{{ $t('layouts.description') }}</p>
                    <p class="mb-3">
                    ...
                    <p class="text-muted text-small mb-2">{{ $t('layouts.rating') }}</p>
                    <div class="mb-3">
                      <stars value="4" :disabled=true></stars>
                    </div>
                    <p class="text-muted text-small mb-2">{{ $t('layouts.price') }}</p>
                    <p class="mb-3">$8,14</p>
                    <p class="text-muted text-small mb-2">{{ $t('layouts.ingredients') }}</p>
                    <div class="mb-3">
                    ...
                    <p class="text-muted text-small mb-2">{{ $t('layouts.is-vegan') }}</p>
                    <p>No</p>
                  </b-card-body>
              </b-card>
              <radial-progress-card :title="$t('layouts.order-status')" :percent="85" no-suffle class="mb-4"/>
              <radial-progress-card :title="$t('layouts.bake-progress')" :percent="40" no-suffle class="mb-4"/>
            </b-colxx>
            <b-colxx xxs="12" lg="8">
              <b-row v-if="isLoad">
              ...
              <b-card class="mb-4" :title="$t('layouts.popularity')"  v-if="isLoad">
                <div class="chart-container">
                  <area-shadow-chart :data="areaChartData" :height="300"/>
                </div>
              </b-card>
              <b-card class="mb-4" :title="$t('layouts.comments')">
