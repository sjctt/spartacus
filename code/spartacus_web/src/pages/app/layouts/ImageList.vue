  ...
  <b-row>
    <b-colxx xxs="12">
      ...
      <div class="float-sm-right">
        <b-button v-b-modal.modalright variant="primary" size="lg" class="top-right-button">{{ $t('layouts.add-new') }}</b-button>
        <b-button-group>
        ...
        <b-modal id="modalright" ref="modalright" :title="$t('layouts.add-new-modal-title')" class="modal-right">
             <b-form>
              <b-form-group :label="$t('layouts.product-name')">
                <b-form-input v-model="newItem.title"  />
              </b-form-group>
              <b-form-group :label="$t('layouts.category')">
                  <v-select  :options="categories" v-model="newItem.category"/>
              </b-form-group>
              <b-form-group  :label="$t('layouts.description')">
                <b-textarea  v-model="newItem.description"  :rows="2" :max-rows="2"/>
              </b-form-group>
              <b-form-group :label="$t('layouts.status')">
              ...
              <template slot="modal-footer">
                <b-button variant="outline-secondary" @click="hideModal('modalright')">{{ $t('layouts.cancel') }}</b-button>
                <b-button variant="primary" @click="addNewItem()" class="mr-1">{{ $t('layouts.submit') }}</b-button>
              </template>
          </b-modal>
