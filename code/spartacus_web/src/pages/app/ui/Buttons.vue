    ...
    <b-colxx xxs="12">
        ...
        <b-card class="mb-4" :title="$t('button.states')">
            <div class="mb-4">
                ...
                <state-button class="mb-3" id="successButton" variant="primary" :click="successButtonClick">{{ $t('button.click-here') }}</state-button>
            </div>
            <div class="mb-4">
                <p class="mb-1">{{ $t('button.states-text-alternate') }}</p>
                <state-button class="mb-3" id="failButton" variant="secondary" :click="failButtonClick">{{ $t('button.click-here') }}</state-button>
            </div>
        </b-card>
        ...
        <b-card class="mb-4" :title="$t('button.sizes')">
            ...
            <div class="mb-4">
                ...
                <b-button class="mb-2" size="xs" variant="secondary">{{ $t('button.extra-small-button') }}</b-button>
            </div>
            <div class="mb-4">
        ...
        <b-card class="mb-4" :title="$t('button.checkbox-radio-button')">
            <div class="mb-4">
                ...
                <b-button variant="primary" class="mb-2" @click="checkButtonCheck(1)" :pressed="checkedCheckboxes.indexOf(1) !== -1">{{ $t('button.checkbox') }}</b-button>
                <br />
                <b-button variant="outline-primary" class="mb-2" @click="checkButtonCheck(2)" :pressed="checkedCheckboxes.indexOf(2) !== -1">{{ $t('button.checkbox') }}</b-button>
            </div>
            <div class="mb-4">
                <h6 class="mb-2 mr-1">{{ $t('button.radio-button') }}</h6>
                <b-button-group class="mb-2">
                    <b-button variant="primary" @click="selectedRadio=1" :pressed="selectedRadio==1">{{ $t('button.radio') }}</b-button>
                    <b-button variant="primary" @click="selectedRadio=2" :pressed="selectedRadio==2">{{ $t('button.radio') }}</b-button>
                    <b-button variant="primary" @click="selectedRadio=3" :pressed="selectedRadio==3">{{ $t('button.radio') }}</b-button>
                </b-button-group>
            </div>
        </b-card>
