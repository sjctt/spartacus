...
/**
 * @author Song
 * @category	DES加解密工具类 为了解决前后端传值敏感信息明文问题 
 * 						解密jsDES加密的数据，与开发助手中的des算法不同
 * @serial
 *【2019年7月23日】	建立对象
 */
public class js_des 
{
    ...
    public static String encryption(String plainData, String secretKey) throws Exception {
        ...
        try {
            ...
            cipher.init(Cipher.ENCRYPT_MODE, generateKey(secretKey.equals("")?GetKey():secretKey));
    ...
    public static String decryption(String secretData, String secretKey) throws Exception {
        ...
        try {
            cipher = Cipher.getInstance(DES_ALGORITHM);
            cipher.init(Cipher.DECRYPT_MODE, generateKey(secretKey.equals("")?GetKey():secretKey));
